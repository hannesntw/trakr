...
const entries: AuditEntry[] = [
  ...
  { id: "4", user: "Hannes", avatar: "H", action: "integration_connected", description: "Connected GitHub repository hannesntw/trakr", target: "GitHub", project: "Trakr", timestamp: "Apr 10, 2026 10:00 AM", ip: "192.168.1.42" },
  ...
  { id: "9", user: "Robin Park", avatar: "R", action: "work_item_deleted", description: "Deleted TRK-456 'Legacy migration script'", target: "TRK-456", project: "Trakr", timestamp: "Apr 6, 2026 03:45 PM", ip: "10.0.0.91" },
  { id: "10", user: "Hannes", avatar: "H", action: "project_created", description: "Created project Trakr (TRK)", target: "Trakr", project: "Trakr", timestamp: "Apr 5, 2026 09:00 AM", ip: "192.168.1.42" },
