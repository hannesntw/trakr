...
describe("Saved queries API", () => {
  ...
  it("GET /api/saved-queries?projectId=test-project-1 returns queries", async () => {
    const req = new NextRequest("http://localhost/api/saved-queries?projectId=test-project-1");
  ...
  it("DELETE removes query", async () => {
    ...
    // Verify it's gone
    const getReq = new NextRequest("http://localhost/api/saved-queries?projectId=test-project-1");
